...
(let ((base00 "#272822")
  ...
  (custom-theme-set-faces 
   ...
   `(escape-glyph ((t (:foreground ,base0B))))
   `(error ((t (:foreground ,base08))))
   `(warning ((t (:foreground ,base09))))
   ...
   ;; Icicles
   `(icicle-Completions-instruction-1 ((t (:foreground ,base09))))
   `(icicle-Completions-instruction-2 ((t (:foreground ,base0D))))
   `(icicle-mode-line-help ((t (:foreground ,base09))))
   `(icicle-annotation ((t (:foreground ,base03))))
   `(icicle-complete-input ((t (:foreground ,base0E))))
   `(icicle-completion ((t (:foreground ,base0C))))
   `(icicle-match-highlight-Completions ((t (:inherit icicle-complete-input :foreground nil))))
   `(icicle-common-match-highlight-Completions ((t (:inherit icicle-match-highlight-Completions :foreground nil))))
   `(icicle-current-candidate-highlight ((t (:background ,base08))))
   `(icicle-historical-candidate ((t (:foreground ,base0A))))
   `(icicle-msg-emphasis ((t (:foreground ,base0E))))
   `(icicle-multi-command-completion ((t (:foreground ,base0E :background nil))))
   `(icicle-mustmatch-completion ((t (:box (:color ,base0D)))))
   `(icicle-special-candidate ((t (:background nil :foreground ,base0C))))
   `(icicle-whitespace-highlight ((t (:background ,base0B))))

   ;; Helm (anything)
   `(helm-header ((t (:inherit header-line))))
   ;; `(helm-source-header ((t (:foreground nil :background ,base0F :height 1.2))))
   ;; `(helm-selection ((t (:inherit highlight :background nil))))
   `(helm-visible-mark ((t (:foreground ,base05, :background ,base09))))
